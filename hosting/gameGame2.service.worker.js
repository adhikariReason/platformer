...
const CACHED_FILES = ["gameGame2.html","gameGame2.js","gameGame2.offline.html","gameGame2.icon.png","gameGame2.apple-touch-icon.png"];
// Files that we might not want the user to preload, and will only be cached on first load.
const CACHABLE_FILES = ["gameGame2.wasm","gameGame2.pck"];
